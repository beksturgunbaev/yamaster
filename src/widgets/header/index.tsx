      ...
      >
        <div className='container mx-auto px-6 py-4'>
          <div className='flex items-center justify-between'>
            ...
            >
              <Image src={logo} alt='YaMaster' width={150} priority />
            </Link>
          ...
          <div className='flex flex-col h-full'>
            <div className='flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-cyan-500 to-blue-600'>
              <Link href='/' onClick={() => setOpen(false)}>
                <Image src={logo} alt='YaMaster' width={120} />
              </Link>
              <button
                onClick={() => setOpen(false)}
                className='flex items-center justify-center w-10 h-10 rounded-full bg-white/20 backdrop-blur-sm text-white hover:bg-white/30 transition-colors duration-300'
            ...
            <div className='flex-1 overflow-y-auto p-6 space-y-2'>
              {NAV_MENU.map((item, index) => (
                ...
                >
                  ...
                  <ChevronRight className='w-5 h-5 text-gray-400 group-hover:text-cyan-600 group-hover:translate-x-1 transition-all duration-300' />
                </Link>
              ))}
            </div>
