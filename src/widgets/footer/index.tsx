      ...
      <div className='relative z-10 container mx-auto px-6 py-16'>
          ...
          <div className='space-y-6'>
            <div>
              ...
              <p className='text-gray-400 text-sm leading-relaxed'>
                Профессиональные сантехнические услуги в Бишкеке. Работаем с 2014 года. Более 1000 довольных клиентов.
              </p>
            </div>
          ...
          <div>
            ...
            <ul className='space-y-4'>
              <li>
                ...
                >
                  <Phone size={20} className='mt-0.5 flex-shrink-0 group-hover:scale-110 transition-transform duration-300' />
              ...
              <li>
                <a
                  ...
                  className='group flex items-start gap-3 text-gray-400 hover:text-cyan-400 transition-colors duration-300'
                >
                  <Mail size={20} className='mt-0.5 flex-shrink-0 group-hover:scale-110 transition-transform duration-300' />
        ...
        <div className='border-t border-gray-800 pt-8 mt-8'>
          <div className='flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500'>
            <p>
              &copy; {currentYear} <span className='font-semibold text-cyan-400'>YaMaster</span> — Все права защищены
            </p>
