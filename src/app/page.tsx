...
export const metadata: Metadata = {
  ...
  description:
    'Сантехнические услуги в Бишкеке: установка, ремонт, обслуживание. Быстрый выезд за 30-60 мин. Гарантия до 12 месяцев. 10+ лет опыта. Честные цены. ☎️ +996 504 454 408',
  keywords:
