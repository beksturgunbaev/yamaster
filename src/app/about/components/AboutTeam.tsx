...
const team = [
  {
    ...
    description:
      'Специалист по сложным сантехническим системам и установке водонагревательного оборудования',
  ...
  },
  {
    ...
    description:
      'Эксперт по монтажу и ремонту канализационных систем, устранению засоров',
  ...
  },
  {
    ...
    description:
      'Специалист широкого профиля, работает со всеми видами сантехнических работ',
  ...
  },
  {
    ...
    description:
      'Эксперт по ремонту смесителей, душевых кабин и сантехнического оборудования',
      ...
      <div className='container mx-auto px-6'>
            ...
            >
              ...
              <div className='p-6 text-center space-y-4'>
                <div className='relative inline-block'>
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${member.gradient} rounded-full blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500`}
                  />

                  <div
                    className={`relative w-24 h-24 mx-auto bg-gradient-to-br ${member.gradient} rounded-full flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300`}
                  >
                ...
                <div>
                  ...
                  <p
                    className={`text-sm font-semibold text-transparent bg-clip-text bg-gradient-to-r ${member.gradient} mb-2`}
                  >
                    {member.role}
                  </p>
        ...
        <div className='bg-gradient-to-br from-cyan-500 to-blue-600 rounded-3xl p-12 text-center text-white shadow-2xl animate-[fadeInUp_0.8s_ease-out_0.6s_both]'>
          ...
          <p className='text-xl text-blue-100 mb-8 max-w-2xl mx-auto'>
            Свяжитесь с нами любым удобным способом, и наши мастера приступят к
